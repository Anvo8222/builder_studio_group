...
function SideBarAdmin(props) {
  return (
    <div className="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative lg:relative xl:relative 2xl:relative md:h-screen lg:h-screen xl:h-screen 2xl:h-screen z-10 sm:w-full min-w-[200px] content-center">
      <div className="md:mt-12 lg:mt-12 xl:mt-12 2xl:mt-12 md:w-48 lg:w-48 xl:w-48 2xl:w-48 md:fixed lg:fixed xl:fixed 2xl:fixed left-0 top-0 sm:content-center content-start text-left justify-between">
        <ul className="list-reset flex sm:flex-row flex-col pt-3 sm:py-[0] py-3 sm:px-1 px-2 sm:text-center text-left">
          <li className="mr-3 flex-1">
            <Link
              to="#"
              className="block sm:py-1 py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500"
            >
          ...
          <li className="mr-3 flex-1">
            <Link
              to="#"
              className="block sm:py-1 py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500"
            >
          ...
          <li className="mr-3 flex-1">
            <Link
              to="#"
              className="block sm:py-1 py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600"
            >
